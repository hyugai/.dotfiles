...
local api = vim.api
local buf_M, win_M
local active_bufs = {} -- dictionary with pairs of "current_line=buf_id", "current_line"is the absolute path to the file
...
function M.main()
    ...
    api.nvim_buf_create_user_command(buf_M, "SelectBuf", M.select_buf, {})
